...
public class AdminProRatioInfoRowMapper implements RowMapper<AdminProRatioInfo> {

	@Override
	public AdminProRatioInfo mapRow(ResultSet rs, int arg1) throws SQLException {

		AdminProRatioInfo ap = new AdminProRatioInfo();
